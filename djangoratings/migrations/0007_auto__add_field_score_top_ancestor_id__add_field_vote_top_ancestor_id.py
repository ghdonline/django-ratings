...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Score.top_ancestor_id'
        db.add_column('djangoratings_score', 'top_ancestor_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Vote.top_ancestor_id'
        db.add_column('djangoratings_vote', 'top_ancestor_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Score.top_ancestor_id'
        db.delete_column('djangoratings_score', 'top_ancestor_id')

        # Deleting field 'Vote.top_ancestor_id'
        db.delete_column('djangoratings_vote', 'top_ancestor_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 14, 1, 52, 266167)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 14, 1, 52, 265951)'}),
        ...
        'djangoratings.score': {
            ...
            'top_ancestor_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'djangoratings.vote': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 14, 1, 52, 267046)'}),
            'date_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 14, 1, 52, 267104)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
